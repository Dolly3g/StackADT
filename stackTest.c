...
void test_push_puts_the_data_on_the_top_of_stack(){
	...
	assertEqual(*(int*)s.list->tail->data,data1);
	assertEqual(push(s,&data2),2);
	assertEqual(*(int*)s.list->tail->data,data2);
}
